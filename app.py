...
curriculum_db = {
    "2학년": {
        "1학기": {
            "영사과_택3": {"과목": ["영어 발표와 토론", "세계시민과 지리", "사회와 문화", "현대사회와 윤리", "물리학", "화학", "생명과학", "지구과학"], "학점": 4},
            "외국어_택1": {"과목": ["일본어", "중국어"], "학점": 3}
        },
        "2학기": {
            "주요_택3": {"과목": ["주제 탐구 독서", "확률과 통계", "영미 문학 읽기", "세계사", "한국지리 탐구", "정치", "인문학과 윤리", "역학과 에너지", "물질과 에너지", "세포와 물질대사", "지구시스템과학"], "학점": 4},
            "외국어_택1": {"과목": ["일본 문화", "중국 문화"], "학점": 3}
        }
    },
    "3학년": {
        "1학기": {
            "주요_택5": {"과목": ["독서와 작문", "문학과 영상", "영어 독해와 작문", "심화 영어", "미적분II", "기하", "경제 수학", "수학과제 탐구", "도시의 미래 탐구", "윤리와 사상", "역사로 탐구하는 현대 세계", "사회문제 탐구", "전자기와 양자", "화학 반응의 세계", "생물의 유전", "행성우주과학"], "학점": 4},
            "지정_택1": {"과목": ["일본어 회화", "중국어 회화", "생태와 환경", "데이터 과학"], "학점": 3},
            "예술_택1": {"과목": ["음악 연주와 창작", "미술 창작"], "학점": 3}
        },
        "2학기": {
            "주요_택5": {"과목": ["독서 토론과 글쓰기", "매체 의사소통", "언어생활 탐구", "실생활 영어 회화", "미디어 영어", "실용 통계", "법과 사회", "여행지리", "윤리문제 탐구", "과학의 역사와 문화", "융합과학 탐구", "기후변화와 환경생태"], "학점": 4},
            "지정_택1": {"과목": ["심화 일본어", "심화 중국어", "인간과 심리", "소프트웨어와 생활"], "학점": 3},
            "예술_택1": {"과목": ["음악 감상과 비평", "미술 감상과 비평"], "학점": 3}
        }
    }
}
...
major_db = {
    ...
    "인문사회계열": {
        ...
        "미디어커뮤ني케이션학과": {"핵심": ["영어 발표와 토론", "매체 의사소통", "미디어 영어"], "권장": ["사회와 문화", "주제 탐구 독서", "소프트웨어와 생활"]},
