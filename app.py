...
# 2. 학년별/학기별/선택그룹별 상세 데이터베이스 구축 (선택 제약 개수 추가 반영)
curriculum_db = {
    "2학년": {
        "1학기": {
...
# ==========================================
# TAB 3: 통합 자동 가이드 추천 모드 (지정 개수 필터 고도화)
# ==========================================
with tab3:
    ...
    if t3_maj:
        ...
        # 학기별 그룹 단위로 순회하면서 규정된 개수만큼만 정확히 슬라이싱하는 알고리즘
