...
def get_subject_explanation(sub_name, major_name):
    ...
    if "미적분" in sub_name:
        ...
        reason = f"미세 물질 of 분자 반응과 신소재 메커니즘을 규명하여 전공 관련 실험 설계의 뼈대를 다집니다."
...
if grade_auth == "현재 1학년 (2학년 선택과목 설계 시기)":
    ...
    with tab1:
        ...
        # [요청 반영]: 단순하고 직관적인 단독 버튼 배치 구조로 교정
    ...
    with tab3:
        ...
        st.info("현재 1학년 학생은 고교학점제 규정상 2학년 and 3학년 과목 설계를 순차적으로 연속 진행해야 합니다. 1번 탭에서 2학년 및 3학년 시뮬레이션을 원스톱으로 마친 뒤, 2번 탭에서 전공에 필요한 22개 매칭 과목 리스트를 받아보십시오.")
